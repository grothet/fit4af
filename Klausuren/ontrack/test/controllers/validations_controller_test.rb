...
class ValidationsControllerTest < ActionController::TestCase
  ...
  test "should create validation" do
    assert_difference('Validation.count') do
      post :create, validation: { comment: @validation.comment, project_id: @validation.project_id, project_id: @validation.project_id, ranking: @validation.ranking, username: @validation.username }
    end
  ...
  test "should update validation" do
    patch :update, id: @validation, validation: { comment: @validation.comment, project_id: @validation.project_id, project_id: @validation.project_id, ranking: @validation.ranking, username: @validation.username }
    assert_redirected_to validation_path(assigns(:validation))
  end
